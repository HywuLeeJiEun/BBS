	...
	<div class="container">
		<table class="table table-striped" style="text-align: center; cellpadding:50px;" >
			<thead>
				...
				<tr>
					<th colspan="5" style=" text-align: center; color:black "> 요약본(Summary) 작성 </th>
				</tr>
			</thead>
		</table>
	</div>
				...
				<table id="Table" class="table" style="text-align: center;">
					...
					<tbody>
						...
						<tr>
							...
							<!-- 업무 내용 -->
							<td style=" border: 1px solid"><textarea name="content" id="content" style="resize: none; width:100%;"><%= content %></textarea></td>
							<!-- 완료일 -->
							<td style="text-align: center; border: 1px solid"><textarea name="end" id="end" style="resize: none; width:100%;"><%= end %></textarea></td>
							<!-- 진행율 -->
							<td style="text-align: center; border: 1px solid"><%= pl %></td>
							<!-- 상태 -->
							<td style="text-align: center; border: 1px solid" id="state"><%= pl %></td>
							<!-- 비고 -->
							<td style=" border: 1px solid"><%= pl %></td>
						</tr>
						<tr>
							<td></td>
						</tr>
				...
				<table id="Table" class="table" style="text-align: center;">
					...
					<tbody style="border: 1px solid">
						...
						<tr>
							...
							<td style="text-align: center; border: 1px solid"><%= pl %></td>
							<!-- 업무 내용 -->
							<td style=" border: 1px solid"><%= ncontent %></td>
							<!-- 완료예정 -->
							<td style="text-align: center; border: 1px solid"><%= ntarget %></td>
							<!-- 비고 -->
							<td style=" border: 1px solid"><%= pl %></td>
						</tr>
					</tbody>
