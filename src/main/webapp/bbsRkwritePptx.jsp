			...
			<div class="col-6 col-md-6">
				<table id="Table" class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<%
						for(int i=0; i< list.size(); i++) { //content의 길이가 더 길 수 있음!
						%>
						<tr>
							<td style="text-align: left;">
								<textarea name="content<%=i%>" id="content<%=i%>" rows="2" style="resize: none; height:30px; width:300px;"><%= list.get(i).getBbsManager() %></textarea>
							</td>
							<td>
