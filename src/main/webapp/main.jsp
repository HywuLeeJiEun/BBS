					...
					<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; cellpadding:50px;" >
						...
						<tbody>
							<tr>
									...
									<td align="center" colspan="1"><input type="date" required class="form-control" placeholder="주간보고 날짜(월 일)" name="bbsDeadline" ></td>
									...
									<tr align="center">
										<td><textarea class="textarea" style="height:180px; width:100%; border:none; overflow:auto" placeholder="구분/담당자"   readonly><%= workSet %>&#10;<%= user.getName(id) %></textarea></td>
									...
									<tr align="center">	
										...
										<!-- 	oninput을 활용하여 숫자와 특수문자(/)만 작성 가능하도록 구현 -->
										 ...
										 <td><textarea class="textarea" id="content_add" style="height:45px;width:100%;" placeholder="업무내용" name="bbsContent_add" oninput="this.value = this.value
												.replace(/[^0-9./.\s.%.-]/g, '')
												.replace(/(\..*)\./g, '$1');"></textarea></td>
										 <td><input type="date" style="height:45px; width:auto;" id="start_add" class="form-control" placeholder="접수일" name="start_add" ></td>
										 <td><input type="date" style="height:45px; width:auto;" id="target_add" class="form-control" placeholder="완료목표일" name="target_add" oninput="this.value = this.value
												.replace(/[^0-9./.\s.%.-]/g, '')
												.replace(/(\..*)\./g, '$1');"></td>	
									...
									<tr align="center">
										<td><textarea class="textarea" required style="height:180px; width:100%; border:none; overflow:auto" placeholder="구분/담당자"   readonly><%= workSet %>&#10;<%= user.getName(id) %></textarea></td>
