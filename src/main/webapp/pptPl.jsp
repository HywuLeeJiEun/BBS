...
<%
	...
	ArrayList<String> list = bbsDAO.getlistSumad(sumad_id);
	
	String bbsDeadline = list.get(18);
	//e_state, w_state => 색상표
	//String e_color = request.getParameter("ecolor");
	//String w_color = request.getParameter("wcolor");
	String e_state = "";
			//request.getParameter("ecolor");//"#ff0000";
	String w_state = "";
			//request.getParameter("wcolor");//"#ffff00";
	
	if(list.get(4).equals("완료")) {
		e_state="#00ff00";
	}else if(list.get(4).equals("진행중")) {
		e_state="#ffff00";
	} else {
		e_state="#ff0000";
	}
	
	if(list.get(12).equals("완료")) {
		w_state="#00ff00";
	}else if(list.get(12).equals("진행중")) {
		w_state="#ffff00";
	} else {
		w_state="#ff0000";
	}
