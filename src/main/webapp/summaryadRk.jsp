...
<body>
	<%
		...
		ArrayList<Sumad> sumad = sumadDAO.getlistSumAlllist(); //승인상태 상관없이 모두 불러옴!
			...
			<table id="bbsTable" class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="summaryadRkUpdate.jsp?sumad_id=<%= sumad.get(i).getSumad_id() %>" data-toggle="tooltip" data-html="true" data-placement="bottom" title="미승인 상태인 경우, 수정 및 삭제가 가능합니다.">
