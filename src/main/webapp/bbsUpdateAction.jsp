					...
					if(bbs.getBbsNTarget() == null){
						...
						NTarget = (String)bbs.getBbsNTarget();
							...
							if(dl != "") {
								...
								int result = bbsDAO.write(id, bbs.getBbsTitle(), name, bbs.getBbsContent(), bbs.getBbsStart(), bbs.getBbsTarget(), bbs.getBbsEnd(), NContent, NStart, NTarget, bbs.getBbsDeadline());
								// 데이터베이스 오류인 경우
								if(result == -1){
									PrintWriter script = response.getWriter();
									script.println("<script>");
