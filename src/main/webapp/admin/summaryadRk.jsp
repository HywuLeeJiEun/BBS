...
<body>
	<%
		...
		//다음  페이지가 있는지 확인
		ArrayList<Sumad> afsumad = sumadDAO.getlistSumAlllist(pageNumber); //승인상태 상관없이 모두 불러옴!
				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						%>
							...
							<!-- 드랍다운 아이템 영역 -->	
							<ul class="dropdown-menu">
								<li class="active"><a href="/BBS/admin/summaryadRk.jsp">조회</a></li>
			...
			<table id="bbsTable" class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/BBS/admin/summaryadRkUpdate.jsp?sumad_id=<%= sumad.get(i).getSumad_id() %>" data-toggle="tooltip" data-html="true" data-placement="bottom" title="미승인 상태인 경우, 수정 및 삭제가 가능합니다.">
