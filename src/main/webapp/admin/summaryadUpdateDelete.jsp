...
<body>
	...
	<div class="container">
		...
		<button style="margin:5px" class="btn btn-primary pull-right" onclick="location.href='/BBS/admin/summaryadRk.jsp'">목록</button>
	</div>
	...
	<div class="container area" style="cursor:pointer;" id="jb-title">
		<table class="table table-striped" style="text-align: center; cellpadding:50px;" >
			<thead>
				...
				<tr>
					<th colspan="5" style=" text-align: center; " data-toggle="tooltip" data-html="true" data-placement="bottom" title="<%= str %>">요약본 수정 및 승인
					<i class="glyphicon glyphicon-info-sign" id="icon"  style="left:5px;"></i></th>
				</tr>
			</thead>
		</table>
	...
	<div class="container">
		<div class="row">
			...
			<a href=/BBS/admin/summaryadRk.jsp style="width:50px;" class="btn btn-primary pull-right form-control" data-toggle="tooltip" data-placement="bottom" title="요약본 조회로 돌아가기" id="summary"> 목록 </a>
		</div>
	</div>
	<%
	}
