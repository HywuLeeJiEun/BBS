				...
				<table id="Table" class="table" style="text-align: center;">
					...
					<tbody>
						...
						<tr>
							...
							<!-- 진행율 -->
							<td style="text-align: center; border: 1px solid"><textarea required name="eprogress" id="eprogress" style="resize: none; width:100%; height:100px"><%= etlist.get(0).getSum_pro() %></textarea></td>
							<!-- 상태 -->
						...
						<tr>
							...
							<!-- 진행율 -->
							<td style="text-align: center; border: 1px solid"><textarea required name="wprogress" id="wprogress" style="resize: none; width:100%; height:100px"><%=  wtlist.get(0).getSum_pro() %></textarea></td>
							<!-- 상태 -->
