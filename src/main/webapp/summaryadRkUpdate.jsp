...
<textarea class="textarea" id="workSet" name="workSet" style="display:none"><%= erpbbs_id %></textarea>
					...
					<li class="dropdown">
						...
						%>
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="summaryadUpdateDelete.jsp">수정 및 승인</a></li>
	...
	<form method="post" action="bbsRkAdminUpdate.jsp" id="bbsRk">
		...
		<% if(sign.equals("승인") || sign.equals("마감")) {  //승인이나 마감 상태시에만 pptx로 출력 가능!%>
				<button type="button" class="btn btn-primary pull-right" style="width:50px; text-align:center; align:center; margin-left:20px" onClick="location.href='summaryadRk.jsp'">목록</button> 
