...
<body>
	...
	<div class="container">
		<div class="row">
			<table id="bbsTable" class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="summaryRkUpdate.jsp?sum_id=<%= sumlist.get(i).getSum_id() %>" data-toggle="tooltip" data-html="true" data-placement="bottom" title="미승인 상태인 경우, 수정 및 삭제가 가능합니다.">
							[<%= pl %>] - summary (<%= dl %>)</a></td>
						<td><%= name %></td>
			...
			<a href="bbsRkwrite.jsp?bbsID=<%=bbsID%>" style="width:50px;" class="btn btn-info pull-right form-control" data-toggle="tooltip" data-placement="bottom" title="요약본(Summary) 작성" id="summary"> 작성 </a>
		</div>
	</div>
